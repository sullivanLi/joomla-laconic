...
<?php if ($this['widgets']->count('bottom-a')) : ?>
	...
	<div class="uk-container uk-container-center">
		...
		<?php if ($this['widgets']->count('footer-over')) : ?>
		<section id="tm-footer-over" class="<?php echo $grid_classes['footer-over']; ?>" data-uk-grid-match="{target:'> div > .uk-panel'}" data-uk-grid-margin><?php echo $this['widgets']->render('footer-over', array('layout'=>$this['config']->get('grid.footer-over.layout'))); ?></section>
		<?php endif; ?>
