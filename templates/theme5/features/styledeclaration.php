...
class GantryFeatureStyleDeclaration extends GantryFeature {
	...
	$lessVariables = array(
            'background-color'  =>$gantry->get('background-color',  '#121212'),
            'background-type'   =>$gantry->get('background-type',   'bg1'),
            'main-accent'       =>$gantry->get('main-accent',       '#c44f42'),
             'main-accent2'       =>$gantry->get('main-accent2',     '#c44f42'),	
		    'linkcolor' => $gantry->get('linkcolor',     '#00a0b0'),
